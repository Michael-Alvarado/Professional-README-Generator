...
function generateMarkdown(data) {
  ...
  ![badmath](https://img.shields.io/github/license/${data.github}/${data.title}?style=for-the-badge)

  ## Badges

  ![badmath](https://img.shields.io/github/repo-size/${data.github}/${data.title}?style=for-the-badge)
  ![badmath](https://img.shields.io/github/languages/count/${data.github}/${data.title}?style=for-the-badge)
